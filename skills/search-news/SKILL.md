---
name: search-news
description: 한국의 현재 종합 이슈를 언론사 원문과 공식 발표에서 발견하고, 같은 사건을 묶어 국내 영향도를 평가하며, 독립 언론 2곳과 필요한 공식 근거로 검증된 단일 뉴스 JSON을 만든다. 오늘 뉴스 찾기, 정치·부동산·경제·사회 후보 비교, 뉴스 사실 검증, upload-news-pick 1단계를 요청할 때 사용한다.
---
...
점수는 [references/impact-scoring.md](references/impact-scoring.md)를 따른다. 포털 랭킹은 관심도 보조 신호일 뿐 사실성·중요도의 증거가 아니다. 정치·부동산은 상시 검색하되 분야 할당량 때문에 낮은 이슈를 올리지 않는다.
