...
- 첫 장은 결과·손실·격차·반전 중 하나가 2초 안에 먼저 보이는 고강도 뉴스 표지로 만들고, 부제의 조건·범위를 같은 화면에서 읽히게 함
...
- 첫 장 제목의 결과·격차·반전이 사진·숫자와 한 덩어리로 시선을 장악하는가
- 강한 제목을 만들려고 경고 아이콘·붉은색·비명형 문구를 근거 없이 남용하지 않았는가
